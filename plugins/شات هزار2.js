/*let handler = m => m; 
 ...
 let responses; 
 if (/^غوكو بحبك|غوكو عاوزه اتجوزك|بحبك|بموت فيك|نتجوز|غوكو هنتجوز امتي|غوكو انت ليا|غوكو بموت فيك$/i.test(m.text)) { 
 responses = [ 
 'شكرا  ',  
 'هفكر في الموضوع',  
 'و انا',  
 ...
 }else if (/^ غوكو عامل ايه|عامله ايه|عاملين ايه|الدنيا عامله ايه|عاملين ايه يشبب$/i.test(m.text)) { 
 responses = [ 
 ...
 }else if (/^غوكو|غوكو عمك|يا غوكو$/i.test(m.text)) { 
 responses = [ 
 'مين بينادي عليا 🥱👾',  
 ' غوكو عمك💯🤺 ',  
